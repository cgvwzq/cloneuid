...
public class ChangeLog {
    ...
    // author: cgvwzq
    // quick fix to support several dialogs
     ...
     * @param context
     */
    public ChangeLog(Context context, int res, String title) {
        this(context, PreferenceManager.getDefaultSharedPreferences(context), res, title);
    }
     ...
     */
    public ChangeLog(Context context, SharedPreferences sp, int res, String title) {
